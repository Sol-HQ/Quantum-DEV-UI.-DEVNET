...
export const mintText = [
  { label: "OGs", mintText: "Mint .3 SOL", buttonLabel: "Mint now!", header: "OG Mint" },
  { label: "WL", mintText: "Mint .4 SOL", buttonLabel: "Mint now!", header: "WL Mint" },
  { label: "Public", mintText: "Mint .5 SOL", buttonLabel: "Mint now!", header: "Public Mint" },
